...
def show_results(img, xyxy, conf, landmarks, class_num, level):
    h, w, c = img.shape
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for j in range(det.size()[0]):
                    ...
                    im0 = show_results(im0, xyxy, conf, landmarks, class_num, blur_level)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='face_blur/face_model.pt',
                        help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='0', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--img-size', type=int, default=640, help='inference size (pixels)')
    parser.add_argument('--project', default=ROOT / '../runs/face_blur', help='save results to project/name')
